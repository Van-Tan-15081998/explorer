        ...
        <div class="word_item_block" :class="isExpanded ? 'expanded' : ''">
            ...
            <div class="word_content_block">
                <div class="word_type_word">
                    ...
                    <div v-if="typeWords.length > 0">
                        <div
                            v-for="i in typeWords"
                            :key="i['id']"
                            :class="classAcronym(getVieTypeWordName(i['id'], 'acronym'))"
                            @click.prevent="gotoWordMeanByTypeWord(i['id'])"
                            class="type_word">
                            <p>{{ getVieTypeWordName(i['id'], 'acronym') }}</p>
                        </div>
                    </div>
                    <div class="popularity_block">
                        <div class="popularity_item">
                            <font-awesome-icon
                                    ...
                                    :class="'star-' + wordData.word.popularity"
                            />
                            <b>
            ...
            <div class="word_content">
                ...
                <div class="content_item" v-if="openTabIndex === 2">
                    <div
                            ...
                            :key="item['id']"
                            :id="generateIDWithPrefix(item['type_word_id'], 'type_word_')"
...
<script>
    export default {
        ...
        watch: {
            'wordData.vie_word_mean_by_type_word': {
                handler(value) {
                    if (value) {
                        console.log(555, value)
                        this.parseTypeWord(value)
                    }
                },
                deep: true
            }
        ...
        methods: {
            ...
            getVieTypeWordName (id, key = 'vie_description') {
                console.log(333, id)
            ...
            getEngTypeWordName (id, key = 'eng_description') {
                let typeWord = this.type_word.find((element) => {
            ...
            parseTypeWord (typeWordData) {
                let returnData = []

                console.log(111, typeWordData)

                typeWordData.forEach((element) => {
                    if (element['type_word_id']) {
                        returnData.push(
                            element['type_word_id']
                        )
                    }
                })
                ...
                console.log(444, this.typeWords)
            },
            ...
            classAcronym(acronym) {
                return {
                    ...
                    'pre': acronym === 'pre',
                    'P': acronym === 'P',
                    'Determine': acronym === 'Determine',
                    'Conjunction': acronym === 'Conjunction',
                    'Interjection': acronym === 'Interjection',
                    'Other': acronym === 'Other',
                }
            },

            gotoWordMeanByTypeWord (typeWordId) {
                this.openTabIndex = 2;
                this.$nextTick(() =>document.querySelector('#' + this.generateIDWithPrefix(typeWordId, 'type_word_'))
                    .scrollIntoView({behavior: 'smooth', block: "center"}))

            },

            generateIDWithPrefix (id, prefix = '') {
                return prefix + id
            }
        },
    }
        ...
        .word_content_block {
            ...
            .word_type_word {
                ...
                .type_word {
                    ...
                    &.adv {
                        background-color: #3FB0D4;
                    }
                    &.pre {
                        background-color: #7F71DF;
                    }
                    &.P {
                        background-color: #F76235;
                    }
                    &.Determine {
                        background-color: #8AC7CA;
                    }
                    &.Conjunction {
    ...
    .word_item_block.expanded {
        ...
        .tabs {
            ul {
                li {
                    .tab_item {
                        width: calc(900px * 0.0909090909090909);
                    }
                }
            }
        }
